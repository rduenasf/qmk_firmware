...
[OSX] = LAYOUT_ergodox(  // layer 0 : default
    // left hand
    ...
    MO(SYMB),       KC_LCTL,      KC_LALT,     KC_LEFT,     KC_RIGHT,
    ...
    KC_TAB,         KC_N,         KC_M,        KC_COMMA,    KC_DOT,      KC_SLASH,         KC_RSPC,
                                  KC_UP,       KC_DOWN,     KC_LBRACKET, KC_RBRACKET,      KC_RCTRL,
...
[SYMB] = LAYOUT_ergodox(
    ...
    KC_MAKE,              KC_UP,    KC_1,  KC_2,      KC_3,     KC_KP_ASTERISK,  KC_F12,
                          KC_DOWN,  KC_4,  KC_5,      KC_6,     KC_KP_PLUS,      _______,
    VRSN,                 KC_AMPR,  KC_7,  KC_8,      KC_9,     KC_NONUS_BSLASH, _______,
    KC_MEDIA_PLAY_PAUSE,  KC_DOT,   KC_0,  KC_EQUAL,  _______,
